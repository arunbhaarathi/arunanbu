  ...
  return (
    <section id="about" className="h-screen flex items-center relative bg-cyber-dark overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto px-6 sm:px-8">
        ...
        <div className="rounded-2xl border border-border bg-card/60 backdrop-blur-sm p-8 sm:p-10 shadow-[var(--shadow-cyber)]">
          <div className="space-y-4 text-base sm:text-lg leading-relaxed text-muted-foreground text-left">
            <p>
